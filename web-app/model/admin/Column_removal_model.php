...
class Column_removal_model{

private $tablename = 'tbl_columns_removal';
private $pk ='id';

private $column_contact_id = 'contact_id';
private $column_user_id = 'user_id';
private $column_column_from = 'column_from';
private $column_column_to = 'column_to';
...
public function __construct(){
	...
	$this->column_column_from,
	$this->column_column_to,
...
public function getAllUploads(){
	...
	$data = inner_join('tbl_columns_removal=*|tbl_user=company_name as company|tbl_contacts=name as contact_name',[
		"tbl_user"=>'tbl_user.user_id=tbl_columns_removal.user_id',
		"tbl_contacts"=>'tbl_contacts.id=tbl_columns_removal.contact_id'
	]);
