...
class Duplicates_model{

private $tablename = 'tbl_duplicates';
private $pk ='id';

private $column_contact_id = 'contact_id';
private $column_user_id = 'user_id';
private $column_file_type = 'file_type';
...
public function getAllUploads(){
	...
	$data = inner_join('tbl_duplicates=*|tbl_user=company_name as company|tbl_contacts=name as contact_name',[
		"tbl_user"=>'tbl_user.user_id=tbl_duplicates.user_id',
		"tbl_contacts"=>'tbl_contacts.id=tbl_duplicates.contact_id'
	]);
